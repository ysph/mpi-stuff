...
int main() {
	...
	be.setRandom(); // sets random image
	
	//start measuring time
	clock_t begin = clock();
	//doing job
	be.findConnectedComponents();
	be.makeConvex();
	be.Jarvis();
	//stop measuring time
	clock_t end = clock();
	...
	cout << "(Sequential) Time spent on finding connected components and making the convex hull is: " << time_spent << " seconds" << endl;
