...
public:	
	...
	void findConnectedComponents__TBB() {
...
int main() {
	...
	clock_t begin = clock();
	//doing job
	be.findConnectedComponents__TBB();
	be.makeConvex();
	be.Jarvis();
	//stop measuring time
	clock_t end = clock();
	...
	cout << "(TBB) Time spent on finding connected components and making the convex hull is: " << time_spent << " seconds" << endl;
